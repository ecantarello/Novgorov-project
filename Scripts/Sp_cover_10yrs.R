...
Cell_stats2<-ddply(Cell_stats,.(species,age,scenario,replicate),summarise,Total=sum(count))
...
P1<-ggplot(Cell_stats3,aes(x=age,y=((Av)/56656)*100,ymax=((Av)/56656)*100,ymin=((Av)/56656)*100,T,colour=scenario))+geom_line(alpha=0.8)+geom_pointrange(shape=1,alpha=0.8)+facet_wrap(~species)+scale_colour_brewer("Scenarios",palette="Set2")
